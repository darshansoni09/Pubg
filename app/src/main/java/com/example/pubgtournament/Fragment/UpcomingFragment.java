                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                per_kill = jsonObject.getString("per_kill");
                                ...
                                Transaction tournament = new Transaction(t_id, pubg_name, history, dateRetofit, timing, first_prize,
                                        per_kill, entry_fee, match_version, map_type, match_type, match_number, result,usersKill,killPayment,chickenStatus,usersPrize);
