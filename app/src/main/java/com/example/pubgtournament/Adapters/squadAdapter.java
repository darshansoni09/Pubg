 ...
 */
public class squadAdapter extends RecyclerView.Adapter<squadAdapter.soloViewHolder> {
    ...
    public squadAdapter(Context context, List<Tournament> tournamentList, String user_id, String user_balance1, String pubg_name) {
    ...
    public soloViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View view=layoutInflater.inflate(R.layout.squaditemfile,viewGroup,false);
    ...
    public void onBindViewHolder(@NonNull soloViewHolder holder, int i) {
        ...
        holder.first_prize_textView.setText(String.valueOf(tournament.getFirst_prize()));
        holder.per_kill_textView.setText(String.valueOf(tournament.getPer_kill_rate()));
        holder.entry_fee_textView.setText(String.valueOf(tournament.getMatch_fee()));
        holder.match_version_textView.setText(tournament.getMatch_version());
        holder.map_type_textView.setText(tournament.getMap_type());
        holder.match_number_textView.setText(String.valueOf(tournament.getMatch_number()));

        holder.btnSquad.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                String entry=holder.entry_fee_textView.getText().toString();
...
//
                if (fee<=0 || fee<e){
                    ...
                    holder.btnSquad.setEnabled(false);

                    Toast.makeText(context, "You Have Successfully Joined Squad Contest", Toast.LENGTH_SHORT).show();
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(context, SquadMatchInfo.class);
                intent.putExtra("first_prize_duo",tournament.getFirst_prize());
                intent.putExtra("per_kill_duo",tournament.getPer_kill_rate());
                intent.putExtra("entry_fee_duo",tournament.getMatch_fee());
                intent.putExtra("match_version_duo",tournament.getMatch_version());
                intent.putExtra("map_type_duo",tournament.getMap_type());
                intent.putExtra("match_number_duo",tournament.getMatch_number());
    ...
    public class soloViewHolder extends RecyclerView.ViewHolder{
        ...
        public soloViewHolder(@NonNull View itemView) {
            ...
            first_prize_textView=itemView.findViewById(R.id.squad_first_prize);
            per_kill_textView=itemView.findViewById(R.id.squad_per_kill);
            entry_fee_textView=itemView.findViewById(R.id.squad_entry_fee);
            match_version_textView=itemView.findViewById(R.id.squad_match_version);
            map_type_textView=itemView.findViewById(R.id.squad_map_type);
            match_number_textView=itemView.findViewById(R.id.squad_match_number);

            btnSquad=itemView.findViewById(R.id.btn_squad);
