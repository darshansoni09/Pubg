...
public class upcomingAdapter extends RecyclerView.Adapter<upcomingAdapter.upcomingViewHolder> {
    ...
    public void onBindViewHolder(@NonNull upcomingViewHolder holder, int i) {
        ...
        holder.match_version_textView.setText(tournament.getMatchVersion());
        holder.map_type_textView.setText(tournament.getMapType());
    ...
    public class upcomingViewHolder extends RecyclerView.ViewHolder{
        ...
        public upcomingViewHolder(@NonNull View itemView) {
            ...
            per_kill_textView=itemView.findViewById(R.id.upcoming_per_kill);
            entry_fee_textView=itemView.findViewById(R.id.upcoming_entry_fee);
            match_version_textView=itemView.findViewById(R.id.upcoming_match_version);
            map_type_textView=itemView.findViewById(R.id.upcoming_map_type);
