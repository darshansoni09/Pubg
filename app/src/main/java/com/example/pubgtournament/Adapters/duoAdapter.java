 ...
 */
public class duoAdapter extends RecyclerView.Adapter<duoAdapter.soloViewHolder> {
    ...
    public duoAdapter(Context context, List<Tournament> tournamentList, String user_balance1, String user_id, String pubg_name) {
    ...
    public soloViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View view=layoutInflater.inflate(R.layout.duoitemfile,viewGroup,false);
    ...
    public void onBindViewHolder(@NonNull soloViewHolder holder, int i) {
        ...
        holder.btnDuo.setOnClickListener(new View.OnClickListener() {
            @Override
...
//
                if (fee<=0 || fee<e){
                    ...
                    holder.btnDuo.setEnabled(false);

                    Toast.makeText(context, "You Have Successfully Joined Duo Contest", Toast.LENGTH_SHORT).show();
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(context, DuoMatchInfo.class);
    ...
    public class soloViewHolder extends RecyclerView.ViewHolder{
        ...
        public soloViewHolder(@NonNull View itemView) {
            ...
            first_prize=itemView.findViewById(R.id.duo_first_prize);
            per_kill=itemView.findViewById(R.id.duo_per_kill);
            entry_fee=itemView.findViewById(R.id.duo_entry_fee);
            match_version=itemView.findViewById(R.id.duo_match_version);
            map_type=itemView.findViewById(R.id.duo_map_type);
            match_number=itemView.findViewById(R.id.duo_match_number);

            btnDuo=itemView.findViewById(R.id.btn_duo);
